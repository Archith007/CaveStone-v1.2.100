...
function draw() {
  ...
  if (gameState === "pause") {
    ...
    if (mousePressedOver(coveStoneB)) {
    ...
    if (mousePressedOver(caveStoneB)) {
    ...
    if (mousePressedOver(cloveStoneB)) {
  ...
  if (gameState === "play") {
    ...
    if (character === "caveStone") {
      ...
      if ((keyWentUp("UP_ARROW")) || (keyDown("SPACE") || keyDown("W"))) {
